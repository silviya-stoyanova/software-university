...
// sofunify.downloadSong('The Best', 'lowerCase', 'bears and wolfs..')
// sofunify.downloadSong('Famous', 'cool', 'blahBlaH')
// console.log(sofunify.rateArtist([]))
// console.log(sofunify.rateArtist('Best', '1'))
