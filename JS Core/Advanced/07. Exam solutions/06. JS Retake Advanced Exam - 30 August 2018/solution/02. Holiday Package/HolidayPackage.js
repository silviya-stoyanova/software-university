...
let holidayPackage = new HolidayPackage('Paris', 'Winter');

holidayPackage.addVacationer('Vakanciq Pochivka')   //* here
holidayPackage.addVacationer('Summer Timeee')
holidayPackage.insuranceIncluded = true
console.log(JSON.stringify(holidayPackage.generateHolidayPackage()))
