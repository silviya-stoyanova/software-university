...
let createCalculator = require('./06. Add, Subtract')

// да се прибавя число
// и да се взима всеки път стойността на let value = createCalculator().get()
// която се проверява дали е еди каква си
